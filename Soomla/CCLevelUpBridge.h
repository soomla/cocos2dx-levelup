...
namespace soomla {
    ...
    /**
     ...
     functions.
     */
    class CCLevelUpBridge : public cocos2d::Ref {
    public:
        /**
        ...
        */
        ...
        void worldSetLastCompletedInnerWorld(CCWorld *world, cocos2d::__String *innerWorldId);
        cocos2d::__String *worldGetLastCompletedInnerWorld(CCWorld *world);
    private:
        void bindNative();
    };
}
