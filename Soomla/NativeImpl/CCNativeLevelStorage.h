...
#ifndef __CCNativeLevelStorage_H_
#define __CCNativeLevelStorage_H_
...
namespace soomla {
     ...
     */
    class CCNativeLevelStorage: public CCLevelStorage {
...
#endif //__CCNativeLevelStorage_H_
