...
- [cocos2dx-store 4.4.0](http://library.soom.la/fetch/cocos2dx-store/4.4.0?cf=github)
- [cocos2dx-profile 1.1.0](http://library.soom.la/fetch/cocos2dx-profile/1.1.0?cf=github)
- [cocos2dx-levelup 1.1.0](http://library.soom.la/fetch/cocos2dx-levelup/1.1.0?cf=github)
