...
####Pre baked zip:
- [soomla-cocos2dx-core 1.1.1](http://library.soom.la/fetch/cocos2dx-core/1.1.1?cf=github)
- [cocos2dx-store 4.4.1](http://library.soom.la/fetch/cocos2dx-store/4.4.1?cf=github)
- [cocos2dx-profile 1.1.1](http://library.soom.la/fetch/cocos2dx-profile/1.1.1?cf=github)
- [cocos2dx-levelup 1.1.1](http://library.soom.la/fetch/cocos2dx-levelup/1.1.1?cf=github)
